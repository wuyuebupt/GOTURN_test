...
def img_resize(patch_current, patch_next):
    patch_current = tf.image.resize_images(patch_current, [HEIGHT,WIDTH],
                            method=tf.image.ResizeMethod.BILINEAR)
    patch_next = tf.image.resize_images(patch_next, [HEIGHT,WIDTH],
                            method=tf.image.ResizeMethod.BILINEAR)
    return patch_current, patch_next
